...
const clientId =
  "536269962551-94rqvm4206q5tthq924t3diai5tvaphj.apps.googleusercontent.com";

const move = () => {
  this.props.history.push("localhost:3000/");
};
    ...
    <>
      <div style={{ display: "flex", flexDirection: "row" }}>
        ...
        <div style={loginformat}>
          <div style={{ fontSize: "25pt", marginBottom: "40px" }}>
            {" "}
            Welcome to <b> Laundry 200 </b>{" "}
          </div>
          <TextField
            id="filled-basic"
            label="ID"
